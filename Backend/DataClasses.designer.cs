...
namespace Lawspot.Backend
{
    ...
    partial void OnPublisherIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_EventStream", Storage="_Events", ThisKey="UserId", OtherKey="UserId")]
    ...
    partial void OnDetailsChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_EventStream", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
